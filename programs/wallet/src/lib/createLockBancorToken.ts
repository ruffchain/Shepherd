...
export async function createLockBancorToken(ctx: IfContext, args: string[]): Promise<IfResult> {
...
export function prnCreateLockBancorToken(ctx: IfContext, obj: IfResult) {
