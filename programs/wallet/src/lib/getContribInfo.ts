...
const FUNC_NAME = 'getContribInfo';

export async function getContribInfo(ctx: IfContext, args: string[]): Promise<IfResult> {
...
export function prnGetContribInfo(ctx: IfContext, obj: IfResult) {
    if (ctx.sysinfo.verbose) {
        console.log(obj);
    }
